...
- viewer_type: map the category — mugs→(mug variant), pins→(pin shape), tshirts→(tee variant), tote_bags→(tote variant), stickers→sticker, calendars→calendar, otherwise none.
   For pins be specific: circle/round→pin_circle, square→pin_square, rectangle→pin_rectangle, oval→pin_oval, heart→pin_heart, star→pin_star, hexagon→pin_hexagon, triangle→pin_triangle, diamond→pin_diamond, cloud→pin_cloud, flower/petal→pin_flower, otherwise pin.
...
PROMPT;
        ...
        $viewers = ['none', 'mug', 'glass_cup', 'tumbler', 'travel_mug', 'coffee_cup', 'teacup', 'espresso', 'latte', 'cappuccino', 'stein', 'tankard', 'pin', 'pin_circle', 'pin_square', 'pin_rectangle', 'pin_oval', 'pin_heart', 'pin_star', 'pin_hexagon', 'pin_triangle', 'pin_diamond', 'pin_cloud', 'pin_flower', 'shirt', 'shirt_regular', 'shirt_oversized', 'shirt_boxy', 'shirt_relaxed', 'shirt_slim', 'shirt_cropped', 'shirt_baby', 'shirt_longline', 'shirt_heavy', 'shirt_ringer', 'shirt_pocket', 'shirt_graphic', 'shirt_crew', 'shirt_vneck', 'shirt_scoop', 'shirt_henley', 'tote', 'mini_tote', 'shoulder_bag', 'crossbody', 'drawstring', 'canvas_bag', 'zip_tote', 'gusseted_tote', 'flat_tote', 'book_tote', 'grocery_tote', 'clear_tote', 'beach_tote', 'laptop_tote', 'leather_tote', 'convertible_tote', 'sticker', 'calendar', 'glb'];
        ...
        if (! in_array($vt, $viewers, true)) {
            ...
            foreach (['henley' => 'shirt_henley', 'ringer' => 'shirt_ringer', 'pocket' => 'shirt_pocket', 'graphic' => 'shirt_graphic', 'baby' => 'shirt_baby', 'cropped' => 'shirt_cropped', 'longline' => 'shirt_longline', 'heavy' => 'shirt_heavy', 'oversized' => 'shirt_oversized', 'boxy' => 'shirt_boxy', 'relaxed' => 'shirt_relaxed', 'slim' => 'shirt_slim', 'v-neck' => 'shirt_vneck', 'v neck' => 'shirt_vneck', 'scoop' => 'shirt_scoop', 'crew' => 'shirt_crew', 'convertible' => 'convertible_tote', 'leather' => 'leather_tote', 'laptop' => 'laptop_tote', 'grocery' => 'grocery_tote', 'beach' => 'beach_tote', 'clear tote' => 'clear_tote', 'clear' => 'clear_tote', 'book' => 'book_tote', 'gusseted' => 'gusseted_tote', 'flat tote' => 'flat_tote', 'zip' => 'zip_tote', 'canvas' => 'canvas_bag', 'crossbody' => 'crossbody', 'shoulder' => 'shoulder_bag', 'mini tote' => 'mini_tote', 'mini' => 'mini_tote', 'drawstring' => 'drawstring', 'travel' => 'travel_mug', 'glass' => 'glass_cup', 'tumbler' => 'tumbler', 'demitasse' => 'espresso', 'espresso' => 'espresso', 'cappuccino' => 'cappuccino', 'latte' => 'latte', 'teacup' => 'teacup', 'tea cup' => 'teacup', 'coffee cup' => 'coffee_cup', 'stein' => 'stein', 'beer' => 'stein', 'tankard' => 'tankard', 'rectangle' => 'pin_rectangle', 'square' => 'pin_square', 'oval' => 'pin_oval', 'heart' => 'pin_heart', 'star' => 'pin_star', 'hexagon' => 'pin_hexagon', 'triangle' => 'pin_triangle', 'diamond' => 'pin_diamond', 'cloud' => 'pin_cloud', 'flower' => 'pin_flower', 'petal' => 'pin_flower', 'circle' => 'pin_circle', 'round' => 'pin_circle', 'mug' => 'mug', 'pin' => 'pin', 'shirt' => 'shirt', 't-shirt' => 'shirt', 'tote' => 'tote', 'sticker' => 'sticker', 'calendar' => 'calendar'] as $needle => $mapped) {
